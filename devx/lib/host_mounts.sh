...
export_host_mount_context() {
  ...
  DEVX_HOST_DYNAMO_FILE_KV_DIR="${DEVX_HOST_DYNAMO_DIR}/file-kv"
  readonly DEVX_HOST_DYNAMO_FILE_KV_DIR
  DEVX_HOST_DYNAMO_HOME_DIR="${DEVX_HOST_DYNAMO_DIR}/home"
  readonly DEVX_HOST_DYNAMO_HOME_DIR
  DEVX_HOST_DYNAMO_HOME_CONFIG_DIR="${DEVX_HOST_DYNAMO_HOME_DIR}/.config"
  readonly DEVX_HOST_DYNAMO_HOME_CONFIG_DIR
  DEVX_HOST_DYNAMO_HOME_CACHE_DIR="${DEVX_HOST_DYNAMO_HOME_DIR}/.cache"
  readonly DEVX_HOST_DYNAMO_HOME_CACHE_DIR
  DEVX_HOST_DYNAMO_HOME_FLASHINFER_DIR="${DEVX_HOST_DYNAMO_HOME_CACHE_DIR}/flashinfer"
  readonly DEVX_HOST_DYNAMO_HOME_FLASHINFER_DIR
...
ensure_host_state_dirs() {
  ...
  install_host_user_dir 755 "${DEVX_HOST_DYNAMO_FILE_KV_DIR}"
  install_host_user_dir 755 "${DEVX_HOST_DYNAMO_HOME_DIR}"
  install_host_user_dir 755 "${DEVX_HOST_DYNAMO_HOME_CONFIG_DIR}"
  install_host_user_dir 755 "${DEVX_HOST_DYNAMO_HOME_CACHE_DIR}"
  install_host_user_dir 755 "${DEVX_HOST_DYNAMO_HOME_FLASHINFER_DIR}"
...
export_host_mount_exports() {
  ...
  export DEVX_HOST_DYNAMO_FILE_KV_DIR
  export DEVX_HOST_DYNAMO_HOME_DIR
  export DEVX_HOST_DYNAMO_HOME_CONFIG_DIR
  export DEVX_HOST_DYNAMO_HOME_CACHE_DIR
  export DEVX_HOST_DYNAMO_HOME_FLASHINFER_DIR
